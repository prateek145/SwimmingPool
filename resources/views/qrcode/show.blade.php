            ...
            <tbody>
                <tr>
                    ...
                    <td style="width:70%; padding-left: 20px;" >
                        ...
                        <h1 style="border-bottom: 2px dotted; margin-bottom:10px ;">Emergency Phone:{{ $member->emergency_phone }}</h1>
                        ...
                        <h1 style="border-bottom: 2px dotted; margin-bottom:10px ;">DOB: {{ $member->dob ?? '' }}</h1>
