...
<body>
    <table style="border: 1px solid; width: 1012px; height: 638px;">
            ...
            <thead>
                <tr>
                    <td colspan="2"><img src="logo.png" style="display: block; height: inherit; float: left; max-width: 20%;"> <img src="logo.png" style="display: block; height: inherit; float: right; max-width: 20%;"> </td>
                </tr>
            </thead>
            <tbody>
                <tr>
